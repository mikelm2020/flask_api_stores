...
class Tag(MethodView):
    ...
    @blp.alt_response(
        400,
        description="REturned if tag is assigned to one o more items. In this case, the tag is not deleted.",
    )
    def delete(self, tag_id):
        ...
        abort(
            400,
            message="Coud not delete tag. Make sure tag is not associated with any items, then try again.",
        )
